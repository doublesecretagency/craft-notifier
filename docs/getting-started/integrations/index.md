---
description: Notifier integrates with a variety of messaging systems (like Twilio, Pushover, ntfy, Slack, and Bluesky). Configure each individual service you plan to connect with.
---

# Integrations

In addition to native support for email, announcements, and flash messages, Notifier can also integrate with a variety of third-party services to send messages through additional channels.
