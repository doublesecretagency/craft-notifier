...
- Fixed bug where [manually triggered](https://plugins.doublesecretagency.com/notifier/events/manual-sending) notifications were logged without being sent.
