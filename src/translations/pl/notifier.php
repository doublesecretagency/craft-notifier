...
return [
    ...
    'Successfully sent Facebook post to "{label}".' => 'Pomyślnie wysłano post Facebook do "{label}".',
    'the attached image could not be read' => 'nie udało się odczytać załączonego obrazu',
    'Successfully sent X (Twitter) post as "{label}".' => 'Pomyślnie wysłano post X (Twitter) jako "{label}".',
    ...
    'Successfully posted to "{label}" Instagram account.' => 'Opublikowano na koncie Instagram "{label}".',
