...
return [
    ...
    'Successfully sent Facebook post to "{label}".' => '"{label}" hedefine Facebook gönderisi başarıyla gönderildi.',
    'the attached image could not be read' => 'eklenen görüntü okunamadı',
    'Successfully sent X (Twitter) post as "{label}".' => '"{label}" olarak X (Twitter) gönderisi başarıyla gönderildi.',
    ...
    'Successfully posted to "{label}" Instagram account.' => '"{label}" Instagram hesabında paylaşıldı.',
