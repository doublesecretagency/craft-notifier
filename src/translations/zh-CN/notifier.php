...
return [
    ...
    'Successfully sent Facebook post to "{label}".' => '已成功发送 Facebook 帖子到 "{label}"。',
    'the attached image could not be read' => '无法读取附加的图片',
    'Successfully sent X (Twitter) post as "{label}".' => '已成功以 "{label}" 发送 X (Twitter) 帖子。',
    ...
    'Successfully sent LinkedIn post to "{label}".' => '已成功发送 LinkedIn 帖子到 "{label}"。',
    ...
    'Successfully posted to "{label}" Instagram account.' => '已发布到 Instagram 账户“{label}”。',
