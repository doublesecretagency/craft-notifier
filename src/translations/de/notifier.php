...
return [
    ...
    'Successfully sent Facebook post to "{label}".' => 'Facebook-Beitrag erfolgreich an "{label}" gesendet.',
    'the attached image could not be read' => 'das angehängte Bild konnte nicht gelesen werden',
    'Successfully sent X (Twitter) post as "{label}".' => 'X (Twitter)-Beitrag erfolgreich als "{label}" gesendet.',
    ...
    'Successfully sent LinkedIn post to "{label}".' => 'LinkedIn-Beitrag erfolgreich an "{label}" gesendet.',
    ...
    'Successfully posted to "{label}" Instagram account.' => 'Beitrag im Instagram-Konto „{label}“ veröffentlicht.',
