...
return [
    ...
    'Successfully sent an email to {name}.' => 'Sähköposti lähetetty kohteelle {name}.',
    'Successfully sent an SMS message to {name}.' => 'SMS-viesti lähetetty kohteelle {name}.',
    'Successfully sent a Pushover notification to {name}.' => 'Pushover-ilmoitus lähetetty kohteelle {name}.',
    'Successfully posted an announcement for {name}.' => 'Ilmoitus julkaistu kohteelle {name}.',
    'Successfully sent a flash message to {name}.' => 'Flash-viesti lähetetty kohteelle {name}.',
    'Successfully posted to Slack in channel "{label}".' => 'Julkaistu Slackin kanavalla "{label}".',
    'Successfully posted to Discord in channel "{label}".' => 'Julkaistu Discordin kanavalla "{label}".',
    'Successfully posted to Facebook as "{label}" account.' => 'Julkaistu Facebook-tilillä "{label}".',
    'Successfully posted to Instagram as "{label}" account.' => 'Julkaistu Instagram-tilillä "{label}".',
    'Successfully posted to X (Twitter) as "{label}" account.' => 'Julkaistu X (Twitter) -tilillä "{label}".',
    'Successfully posted to Bluesky as "{label}" account.' => 'Julkaistu Bluesky-tilillä "{label}".',
    'Successfully posted to Mastodon as "{label}" account.' => 'Julkaistu Mastodon-tilillä "{label}".',
    'Successfully posted to LinkedIn as "{label}" account.' => 'Julkaistu LinkedIn-tilillä "{label}".',
