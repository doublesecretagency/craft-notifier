...
return [
    ...
    'Successfully sent Facebook post to "{label}".' => 'Post Facebook inviato con successo a "{label}".',
    'the attached image could not be read' => "non è stato possibile leggere l'immagine allegata",
    'Successfully sent X (Twitter) post as "{label}".' => 'Post X (Twitter) inviato con successo come "{label}".',
    ...
    'Successfully posted to "{label}" Instagram account.' => 'Pubblicato sull’account Instagram "{label}".',
