...
return [
    ...
    'Successfully sent Facebook post to "{label}".' => 'Facebook-inlägg skickat till "{label}".',
    'the attached image could not be read' => 'den bifogade bilden kunde inte läsas',
    'Successfully sent X (Twitter) post as "{label}".' => 'X (Twitter)-inlägg skickat som "{label}".',
    ...
    'Successfully sent LinkedIn post to "{label}".' => 'LinkedIn-inlägg skickat till "{label}".',
    ...
    'Successfully posted to "{label}" Instagram account.' => 'Publicerat på Instagram-kontot "{label}".',
