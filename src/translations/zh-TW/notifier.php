...
return [
    ...
    'Successfully sent Facebook post to "{label}".' => '已成功傳送 Facebook 貼文到「{label}」。',
    'the attached image could not be read' => '無法讀取附加的圖片',
    'Successfully sent X (Twitter) post as "{label}".' => '已成功以「{label}」傳送 X (Twitter) 貼文。',
    ...
    'Successfully posted to "{label}" Instagram account.' => '已發佈到 Instagram 帳戶「{label}」。',
