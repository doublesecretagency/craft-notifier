...
return [
    ...
    'Successfully sent Facebook post to "{label}".' => 'Facebook-bericht succesvol verzonden naar "{label}".',
    'the attached image could not be read' => 'de bijgevoegde afbeelding kon niet worden gelezen',
    'Successfully sent X (Twitter) post as "{label}".' => 'X (Twitter)-bericht succesvol verzonden als "{label}".',
    ...
    'Successfully posted to "{label}" Instagram account.' => 'Geplaatst op het Instagram-account "{label}".',
