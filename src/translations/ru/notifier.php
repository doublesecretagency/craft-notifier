...
return [
    ...
    'Successfully sent an email to {name}.' => 'Письмо успешно отправлено {name}.',
    'Successfully sent an SMS message to {name}.' => 'SMS-сообщение успешно отправлено {name}.',
    'Successfully sent a Pushover notification to {name}.' => 'Уведомление Pushover успешно отправлено {name}.',
    'Successfully posted an announcement for {name}.' => 'Объявление успешно опубликовано для {name}.',
    'Successfully sent a flash message to {name}.' => 'Flash-сообщение успешно отправлено {name}.',
    'Successfully posted to Slack in channel "{label}".' => 'Успешно опубликовано в Slack в канале "{label}".',
    'Successfully posted to Discord in channel "{label}".' => 'Успешно опубликовано в Discord в канале "{label}".',
    'Successfully posted to Facebook as "{label}" account.' => 'Успешно опубликовано в Facebook как аккаунт "{label}".',
    'Successfully posted to Instagram as "{label}" account.' => 'Успешно опубликовано в Instagram как аккаунт "{label}".',
    'Successfully posted to X (Twitter) as "{label}" account.' => 'Успешно опубликовано в X (Twitter) как аккаунт "{label}".',
    'Successfully posted to Bluesky as "{label}" account.' => 'Успешно опубликовано в Bluesky как аккаунт "{label}".',
    'Successfully posted to Mastodon as "{label}" account.' => 'Успешно опубликовано в Mastodon как аккаунт "{label}".',
    'Successfully posted to LinkedIn as "{label}" account.' => 'Успешно опубликовано в LinkedIn как аккаунт "{label}".',
