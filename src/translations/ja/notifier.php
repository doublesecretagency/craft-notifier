...
return [
    ...
    'Successfully sent Facebook post to "{label}".' => '"{label}" に Facebook の投稿を正常に送信しました。',
    'the attached image could not be read' => '添付された画像を読み取れませんでした',
    'Successfully sent X (Twitter) post as "{label}".' => '"{label}" として X (Twitter) の投稿を正常に送信しました。',
    ...
    'Successfully posted to "{label}" Instagram account.' => 'Instagram アカウント「{label}」に投稿しました。',
