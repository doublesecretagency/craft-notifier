...
return [
    ...
    'Commerce Products Event'                              => 'Evento de Produtos Commerce',
    'Digital Products Event'                               => 'Evento Digital Products',
    'Digital Product Licenses Event'                       => 'Evento de Licenças Digital Products',
    ...
    // Test notification
    'Send a test message'                                                                                                          => 'Enviar mensagem de teste',
    'Are you certain you want to send a test notification?\n\nThe configured message will be sent to the configured recipient(s).' => 'Tem a certeza de que pretende enviar uma notificação de teste?\n\nA mensagem configurada será enviada para os destinatários configurados.',
    'Test'                                                                                                                         => 'Teste',
    'Test notification dispatched.'                                                                                                => 'Notificação de teste enviada.',
    'No messages were dispatched. Check the recipient configuration.'                                                              => 'Não foi enviada nenhuma mensagem. Verifique a configuração dos destinatários.',
    ...
    'Recipient "{name}" has no associated User; cannot send announcement.' => 'O destinatário "{name}" não tem um utilizador associado; não é possível enviar o anúncio.',
    'Recipient "{name}" cannot access the control panel; cannot send announcement.' => 'O destinatário "{name}" não pode aceder ao painel de controlo; não é possível enviar o anúncio.',
