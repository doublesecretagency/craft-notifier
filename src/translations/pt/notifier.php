...
return [
    ...
    'Successfully sent Facebook post to "{label}".' => 'Publicação do Facebook enviada com sucesso para "{label}".',
    'the attached image could not be read' => 'não foi possível ler a imagem anexada',
    'Successfully sent X (Twitter) post as "{label}".' => 'Publicação do X (Twitter) enviada com sucesso como "{label}".',
    ...
    'Successfully sent LinkedIn post to "{label}".' => 'Publicação LinkedIn enviada com sucesso para "{label}".',
    ...
    'Successfully posted to "{label}" Instagram account.' => 'Publicado na conta do Instagram "{label}".',
