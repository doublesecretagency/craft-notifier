...
return [
    ...
    'Recipient "{name}" cannot access the control panel; cannot send announcement.' => 'Le destinataire "{name}" ne peut pas accéder au panneau de configuration ; impossible d’envoyer l’annonce.',
