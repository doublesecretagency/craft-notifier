...
return [
    ...
    'Successfully sent Facebook post to "{label}".' => 'Facebook-innlegg sendt til "{label}".',
    'the attached image could not be read' => 'det vedlagte bildet kunne ikke leses',
    'Successfully sent X (Twitter) post as "{label}".' => 'X (Twitter)-innlegg sendt som "{label}".',
    ...
    'Successfully posted to "{label}" Instagram account.' => 'Innlegg publisert til Instagram-kontoen "{label}".',
