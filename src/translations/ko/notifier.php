...
return [
    ...
    'Successfully sent an email to {name}.' => '{name}에게 이메일을 성공적으로 보냈습니다.',
    'Successfully sent an SMS message to {name}.' => '{name}에게 SMS 메시지를 성공적으로 보냈습니다.',
    'Successfully sent a Pushover notification to {name}.' => '{name}에게 Pushover 알림을 성공적으로 보냈습니다.',
    'Successfully posted an announcement for {name}.' => '{name}에 대한 공지를 성공적으로 게시했습니다.',
    'Successfully sent a flash message to {name}.' => '{name}에게 플래시 메시지를 성공적으로 보냈습니다.',
    'Successfully posted to Slack in channel "{label}".' => 'Slack 채널 "{label}"에 성공적으로 게시했습니다.',
    'Successfully posted to Discord in channel "{label}".' => 'Discord 채널 "{label}"에 성공적으로 게시했습니다.',
    'Successfully posted to Facebook as "{label}" account.' => 'Facebook에 "{label}" 계정으로 성공적으로 게시했습니다.',
    'Successfully posted to Instagram as "{label}" account.' => 'Instagram에 "{label}" 계정으로 성공적으로 게시했습니다.',
    'Successfully posted to X (Twitter) as "{label}" account.' => 'X (Twitter)에 "{label}" 계정으로 성공적으로 게시했습니다.',
    'Successfully posted to Bluesky as "{label}" account.' => 'Bluesky에 "{label}" 계정으로 성공적으로 게시했습니다.',
    'Successfully posted to Mastodon as "{label}" account.' => 'Mastodon에 "{label}" 계정으로 성공적으로 게시했습니다.',
    'Successfully posted to LinkedIn as "{label}" account.' => 'LinkedIn에 "{label}" 계정으로 성공적으로 게시했습니다.',
